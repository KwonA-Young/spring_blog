...
<body>
    <div class="container">
        ...
        <div class="row">
            <!-- 비동기 form의 경우는 목적지로 이동하지 않고 페이지 내에서 처리가 되므로 action을 가지지 않습니다. 그리고 제출버튼도 제출기능을 막고 fetch 요청만 넣습니다. -->
            <div class="col-2">
...
<script>
    ...
    $replies.onclick = (e) => {
        ...
        if(confirm("삭제하시겠습니까?")) { // 예, 아니오로 대답할 수 있는 경고창을 띄운다.
            // 예를 선택하면 true, 아니오를 선택하면 false.
