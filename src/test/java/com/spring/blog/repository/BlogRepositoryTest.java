...
public class BlogRepositoryTest {
    ...
    public void setBlogRepository() {
        blogRepository.createBlogTable();  // blog테이블 생성.
    ...
    public void findAllTest() {
        ...
        int blogId = 1; // 잦바 자료구조 인덱스는 0번부터.

        // when : DB 에 있는 모든 데이터를 자바 엔터티로 역직렬화
    ...
    public void saveTest() {
        ...
        int blogId = 3; // 4번째 요소 조회 (자바 인덱스는 0부터 시작)
        ...
        // 그리고  방금 INSERT 한 데이터의 writer, blogTitle, blogContent 가
    ...
    @Test
    @DisplayName("2번 글을 조회했을 때, 제목과 글쓴이와 번호가 단언했던대로 받아와지는지 확인. ")
    ...
    public void deleteByIdTest() {
        ...
        // when : 삭제로직 실행 후, findAll(). findById() 로 전체행, 개별행 가져오기.
        blogRepository.deleteById(blogId);

        // then : 단언을 이용해서 전체 행 2개, 개별행은 null 임을 확인.
