...
public class ReplyRepositoryTest {
    ...
    @Autowired // 테스트 코드에서는 필드주입을 써도 무방합니다.
    ...
    @Test
    @Transactional
    @DisplayName("댓글번호 3번 자료의 댓글은 3번이고, 글쓴이는 '스키'.")
    ...
    @Test @Transactional
    @DisplayName("댓글번호 2번을 삭제한 다음, 전체 데이터 개수가 4개로, 그리고 2번으로 재조회시 null 일 것이다.")
    ...
    @Test
    @Transactional
    @DisplayName("fixture로 수정할 댓글쓴이, 댓글내용, 3번 replyId 지정. 수정 후 3번 자료를 DB에서 꺼내 fixture 비교 및 published_at 과 updated_at이 다른지 확인.")
